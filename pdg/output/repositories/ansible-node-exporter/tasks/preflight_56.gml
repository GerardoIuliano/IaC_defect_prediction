...
<node id="56">
  ...
  <data key="d6">"Assert that TLS key and cert are present"</data>
</node>
<node id="57">
  <data key="d2">Literal</data>
  <data key="d3">57</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/ansible-node-exporter/tasks/preflight.yml", "line": 50, "column": 11, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/ansible-node-exporter/tasks/main.yml", "line": 2, "column": 3, "includer_location": null}}</data>
  <data key="d7">"list"</data>
  <data key="d8">"['{{ __node_exporter_cert_file.stat.exists }}', '{{ __node_exporter_key_file.stat.exists }}']"</data>
</node>
<node id="58">
  <data key="d2">Task</data>
  <data key="d3">58</data>
  ...
  <data key="d6">"Check if node_exporter is installed"</data>
</node>
<node id="52">
  <data key="d2">Task</data>
  <data key="d3">52</data>
  ...
  <data key="d5">"stat"</data>
  <data key="d6">"Check existence of TLS key file"</data>
</node>
<edge source="56" target="58">
  <data key="d9">ORDER</data>
  <data key="d10">false</data>
  <data key="d11">false</data>
  <data key="d12">56-58-0</data>
</edge>
