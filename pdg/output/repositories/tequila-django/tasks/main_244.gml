...
<node id="245">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/tequila-django/tasks/main.yml", "line": 241, "column": 11, "includer_location": null}</data>
  <data key="d9">"{{ django_dir }}/manage.py"</data>
  <data key="d10">[]</data>
</node>
<node id="246">
  <data key="d2">IntermediateValue</data>
...
<edge source="45" target="245" id="45-245-0">
  <data key="d15">USE</data>
</edge>
...
<edge source="246" target="244" id="246-244-0">
  <data key="d15">KEYWORD</data>
  <data key="d18">"args.path"</data>
</edge>
<edge source="247" target="244" id="247-244-0">
  <data key="d15">KEYWORD</data>
