...
<node id="221">
  ...
  <data key="d11">"{{ source_dir ~ '/' ~ project_subdir if project_subdir != '' else source_dir }}"</data>
  <data key="d12">[]</data>
</node>
<node id="222">
  <data key="d2">IntermediateValue</data>
...
<node id="225">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/tequila-django/tasks/main.yml", "line": 201, "column": 11, "includer_location": null}</data>
  <data key="d11">"{{ venv_dir }}/lib/python{{ python_version }}/site-packages/project.pth"</data>
  <data key="d12">[]</data>
</node>
<node id="226">
  <data key="d2">IntermediateValue</data>
...
<edge source="0" target="225" id="0-225-0">
...
<edge source="4" target="225" id="4-225-0">
  <data key="d15">USE</data>
</edge>
...
<edge source="224" target="220" id="224-220-0">
...
<edge source="226" target="220" id="226-220-0">
  <data key="d15">KEYWORD</data>
