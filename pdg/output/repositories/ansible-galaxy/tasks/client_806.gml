...
<node id="806">
  ...
  <data key="d8">"Collect installed node version"</data>
</node>
<node id="807">
  <data key="d2">Expression</data>
  ...
  <data key="d5">"__galaxy_node_is_installed.stat.exists"</data>
  <data key="d6">[]</data>
</node>
<node id="808">
  <data key="d2">IntermediateValue</data>
...
<node id="812">
  ...
  <data key="d8">"__galaxy_installed_node_version"</data>
  <data key="d9">0</data>
  <data key="d10">0</data>
  <data key="d11">18</data>
</node>
<node id="810">
  ...
  <data key="d5">"{{ galaxy_venv_dir }}/bin/node --version"</data>
  <data key="d6">[]</data>
</node>
<node id="38">
  <data key="d2">Variable</data>
