...
<node id="583">
  ...
  <data key="d12">"      Insecure = {{ gitlab_runner.cache_s3_insecure|default(\"\") | lower }}"</data>
  <data key="d13">[]</data>
</node>
<node id="584">
  <data key="d2">IntermediateValue</data>
...
<node id="585">
  ...
  <data key="d12">"{{ 'present' if gitlab_runner.cache_s3_insecure is defined else 'absent' }}"</data>
  <data key="d13">[]</data>
</node>
<node id="586">
  <data key="d2">IntermediateValue</data>
...
<edge source="584" target="1430">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.line"</data>
  <data key="d18">584-1430-0</data>
</edge>
<edge source="585" target="586">
  <data key="d15">DEF</data>
  <data key="d18">585-586-0</data>
</edge>
<edge source="586" target="1430">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.state"</data>
  <data key="d18">586-1430-0</data>
</edge>
