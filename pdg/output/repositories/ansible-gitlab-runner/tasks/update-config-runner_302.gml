...
<node id="304">
  ...
  <data key="d7">"  executor = {{ gitlab_runner.executor|default(\"shell\") | to_json }}"</data>
  <data key="d8">[]</data>
</node>
<node id="305">
  <data key="d2">IntermediateValue</data>
...
<edge source="305" target="302">
  ...
  <data key="d18">305-302-0</data>
</edge>
<edge source="306" target="302">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.state"</data>
  <data key="d18">306-302-0</data>
</edge>
<edge source="307" target="302">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.insertafter"</data>
  <data key="d18">307-302-0</data>
</edge>
<edge source="308" target="302">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.backrefs"</data>
  <data key="d18">308-302-0</data>
</edge>
<edge source="309" target="302">
  <data key="d15">KEYWORD</data>
  <data key="d19">"check_mode"</data>
  <data key="d18">309-302-0</data>
</edge>
