...
<node id="1935">
  ...
  <data key="d6">"(Windows) Create temporary file config.toml"</data>
</node>
<node id="1936">
...
<node id="1938">
  ...
  <data key="d6">"config_toml_temp"</data>
  <data key="d9">0</data>
  <data key="d10">0</data>
