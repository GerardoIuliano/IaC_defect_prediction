...
<node id="339">
  ...
  <data key="d13">"    image = {{ gitlab_runner.docker_image|default(\"\") | to_json }}"</data>
  <data key="d14">[]</data>
</node>
<node id="341">
  <data key="d2">Expression</data>
  ...
  <data key="d13">"{{ 'present' if gitlab_runner.docker_image is defined else 'absent' }}"</data>
  <data key="d14">[]</data>
</node>
<node id="93">
  <data key="d2">Variable</data>
...
<edge source="338" target="337">
  ...
  <data key="d16">338-337-0</data>
</edge>
<edge source="211" target="329">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.dest"</data>
  <data key="d16">211-329-0</data>
</edge>
