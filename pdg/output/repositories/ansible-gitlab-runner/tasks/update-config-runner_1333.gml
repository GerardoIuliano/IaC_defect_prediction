...
<node id="429">
  ...
  <data key="d12">"    volumes = {{ gitlab_runner.docker_volumes|default([])|to_json }}"</data>
  <data key="d13">[]</data>
</node>
<node id="1201">
  <data key="d2">Literal</data>
...
<node id="431">
  ...
  <data key="d12">"{{ 'present' if gitlab_runner.docker_volumes is defined else 'absent' }}"</data>
  <data key="d13">[]</data>
</node>
<node id="1328">
  <data key="d2">Task</data>
...
<edge source="430" target="1333">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.line"</data>
  <data key="d16">430-1333-0</data>
</edge>
...
<edge source="1336" target="1333">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.backrefs"</data>
  <data key="d16">1336-1333-0</data>
</edge>
...
<edge source="93" target="429">
  <data key="d15">USE</data>
  <data key="d16">93-429-0</data>
</edge>
<edge source="93" target="431">
  <data key="d15">USE</data>
  <data key="d16">93-431-0</data>
</edge>
</graph></graphml>