...
<node id="455">
  ...
  <data key="d10">"{{ lookup('template', 'config.runners.docker.services.j2') if gitlab_runner.docker_services is defined }}"</data>
  <data key="d11">["lookup 'template'"]</data>
</node>
<node id="456">
...
<node id="457">
  ...
  <data key="d10">"{{ 'present' if gitlab_runner.docker_services is defined else 'absent' }}"</data>
  <data key="d11">[]</data>
</node>
<node id="458">
  <data key="d2">IntermediateValue</data>
...
<node id="459">
  ...
  <data key="d14">"# {mark} runners.docker.services"</data>
</node>
<node id="204">
  <data key="d2">Variable</data>
...
<edge source="460" target="454">
  ...
  <data key="d18">460-454-0</data>
</edge>
<edge source="461" target="454">
  <data key="d15">KEYWORD</data>
  <data key="d19">"check_mode"</data>
  <data key="d18">461-454-0</data>
</edge>
...
<edge source="211" target="445">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.dest"</data>
  <data key="d18">211-445-0</data>
</edge>
<edge source="211" target="454">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.dest"</data>
  <data key="d18">211-454-0</data>
</edge>
<edge source="211" target="462">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.dest"</data>
  <data key="d18">211-462-0</data>
</edge>
...
<edge source="93" target="455">
  <data key="d15">USE</data>
  <data key="d18">93-455-0</data>
</edge>
<edge source="93" target="457">
  <data key="d15">USE</data>
  <data key="d18">93-457-0</data>
</edge>
