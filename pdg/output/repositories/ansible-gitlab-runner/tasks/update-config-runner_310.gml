...
<node id="314">
  ...
  <data key="d9">"{{ 'present' if gitlab_runner.shell is defined else 'absent' }}"</data>
  <data key="d10">[]</data>
</node>
<node id="315">
  <data key="d2">IntermediateValue</data>
...
<edge source="315" target="310">
  ...
  <data key="d18">315-310-0</data>
</edge>
<edge source="316" target="310">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.insertafter"</data>
  <data key="d18">316-310-0</data>
</edge>
<edge source="317" target="310">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.backrefs"</data>
  <data key="d18">317-310-0</data>
</edge>
<edge source="318" target="310">
  <data key="d15">KEYWORD</data>
  <data key="d19">"check_mode"</data>
  <data key="d18">318-310-0</data>
</edge>
...
<edge source="93" target="312">
  <data key="d15">USE</data>
  <data key="d18">93-312-0</data>
</edge>
<edge source="93" target="314">
  <data key="d15">USE</data>
  <data key="d18">93-314-0</data>
</edge>
</graph></graphml>