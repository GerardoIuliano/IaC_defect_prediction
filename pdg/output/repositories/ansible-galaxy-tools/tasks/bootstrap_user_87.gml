...
<node id="88">
  ...
  <data key="d12">"(create_user is defined) and create_user and (admin_users_found.msg == \"\") and ('.ini' in galaxy_config_file)"</data>
  <data key="d13">[]</data>
</node>
<node id="89">
  <data key="d2">IntermediateValue</data>
...
<edge source="93" target="87">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.regexp"</data>
  <data key="d16">93-87-0</data>
</edge>
