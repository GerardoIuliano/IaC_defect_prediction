...
<node id="57">
  ...
  <data key="d5">"Copy the bootstrap user management script"</data>
</node>
<node id="63">
  <data key="d2">Task</data>
  <data key="d3">63</data>
...
<node id="66">
  ...
  <data key="d12">"(create_user is defined) and create_user"</data>
  <data key="d13">[]</data>
</node>
<node id="67">
  <data key="d2">IntermediateValue</data>
...
<node id="69">
  ...
  <data key="d12">"{{ galaxy_server_dir }}"</data>
  <data key="d13">[]</data>
</node>
<node id="70">
  <data key="d2">IntermediateValue</data>
...
<node id="71">
  ...
  <data key="d12">"{{ galaxy_server_dir }}/.venv"</data>
  <data key="d13">[]</data>
</node>
<node id="72">
  <data key="d2">IntermediateValue</data>
...
<node id="75">
  ...
  <data key="d3">75</data>
  <data key="d4">{"file": "unknown file", "line": -1, "column": -1, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/ansible-galaxy-tools/tasks/main.yml", "line": 7, "column": 3, "includer_location": null}}</data>
  <data key="d5">"galaxy_tools_admin_user_password"</data>
  <data key="d6">0</data>
  <data key="d7">0</data>
  <data key="d8">0</data>
</node>
<node id="76">
  ...
  <data key="d3">76</data>
  <data key="d4">{"file": "unknown file", "line": -1, "column": -1, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/ansible-galaxy-tools/tasks/main.yml", "line": 7, "column": 3, "includer_location": null}}</data>
  <data key="d12">"{{ galaxy_venv_dir }}/bin/python manage_bootstrap_user.py -c {{ galaxy_config_file }} create -e {{ galaxy_tools_admin_user }} -u {{ galaxy_tools_admin_username }} -p {{ galaxy_tools_admin_user_password }} {% if galaxy_tools_admin_user_preset_api_key|bool %} -a {{ galaxy_tools_api_key }} {% endif %}\n"</data>
  <data key="d13">[]</data>
</node>
<node id="77">
  <data key="d2">IntermediateValue</data>
