...
<node id="97">
  ...
  <data key="d9">"pve_cluster_enabled | bool"</data>
  <data key="d10">[]</data>
</node>
<node id="98">
...
<node id="103">
  ...
  <data key="d5">"Ensure this host is in the group specified"</data>
</node>
<node id="104">
...
<node id="105">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/ansible-role-proxmox/tasks/main.yml", "line": 20, "column": 7, "includer_location": null}</data>
  <data key="d12">"list"</data>
  <data key="d13">"['inventory_hostname in groups[pve_group]']"</data>
</node>
<node id="106">
  <data key="d2">Expression</data>
  <data key="d3">106</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/ansible-role-proxmox/tasks/main.yml", "line": 21, "column": 10, "includer_location": null}</data>
  <data key="d9">"This host does not appear to be in the group {{ pve_group }}, did you specify the pve_group host variable correctly?"</data>
  <data key="d10">[]</data>
</node>
<node id="107">
  <data key="d2">IntermediateValue</data>
...
<node id="108">
  ...
  <data key="d5">"Create SSH directory for root"</data>
</node>
<node id="45">
  <data key="d2">Variable</data>
  <data key="d3">45</data>
...
<edge source="0" target="106" id="0-106-0">
...
<edge source="105" target="103" id="105-103-0">
...
<edge source="107" target="103" id="107-103-0">
  <data key="d15">KEYWORD</data>
