...
<node id="313">
  ...
  <data key="d11">"nmi_watchdog"</data>
</node>
<node id="314">
  <data key="d2">Literal</data>
...
<node id="315">
  ...
  <data key="d9">"modprobe"</data>
  <data key="d5">"Attempt to unload softdog live"</data>
</node>
...
<edge source="313" target="312" id="313-312-0">
  <data key="d15">KEYWORD</data>
  <data key="d18">"args.name"</data>
</edge>
<edge source="314" target="312" id="314-312-0">
  <data key="d15">KEYWORD</data>
