...
<node id="1530">
  ...
  <data key="d5">"SCORED | 2.1.1 | PATCH | Ensure chargen services are not enabled | chargen-dgram"</data>
</node>
<node id="1531">
  <data key="d2">Literal</data>
  <data key="d3">1531</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/Ubuntu1804-CIS/tasks/section2.yml", "line": 6, "column": 19, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/Ubuntu1804-CIS/tasks/main.yml", "line": 30, "column": 3, "includer_location": null}}</data>
  <data key="d9">"str"</data>
  <data key="d10">"/etc/xinetd.d/chargen-dgram"</data>
</node>
<node id="1532">
  <data key="d2">Variable</data>
  ...
  <data key="d5">"chargen_dgram_service"</data>
  <data key="d6">0</data>
  <data key="d7">0</data>
  <data key="d8">18</data>
</node>
...
<edge source="1529" target="1532">
  ...
  <data key="d16">1529-1532-0</data>
</edge>
<edge source="1530" target="1532">
  <data key="d15">DEF</data>
  <data key="d16">1530-1532-0</data>
</edge>
