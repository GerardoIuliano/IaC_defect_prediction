...
<node id="892">
  ...
  <data key="d5">"stat"</data>
  <data key="d6">"PRELIM | Check the grub.conf configuration"</data>
</node>
<node id="893">
  ...
  <data key="d8">"/boot/grub/grub.conf"</data>
</node>
<node id="894">
