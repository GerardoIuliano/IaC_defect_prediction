...
<node id="986">
  ...
  <data key="d12">"str"</data>
  <data key="d13">"/usr/local/libexec/slurm/epilog.d"</data>
</node>
<node id="987">
  <data key="d2">Literal</data>
