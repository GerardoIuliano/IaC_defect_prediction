...
<node id="517">
  ...
  <data key="d6">"template in slurmdbd.conf"</data>
</node>
<node id="523">
  <data key="d2">Task</data>
  ...
  <data key="d5">"template"</data>
  <data key="d6">"template in dump-all-databases.sh"</data>
</node>
<node id="524">
  ...
  <data key="d8">"dump-all-databases.sh.j2"</data>
</node>
<node id="525">
  <data key="d2">Literal</data>
  ...
  <data key="d4">{"file": "unknown file", "line": -1, "column": -1, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/ansible-role-slurm/tasks/redhat.yml", "line": 39, "column": 3, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/ansible-role-slurm/tasks/main.yml", "line": 4, "column": 3, "includer_location": null}}}</data>
  <data key="d7">"str"</data>
  <data key="d8">"/usr/local/sbin/dump-all-databases.sh"</data>
</node>
<node id="526">
  <data key="d2">Literal</data>
...
<edge source="517" target="523">
  ...
  <data key="d12">517-523-0</data>
</edge>
<edge source="523" target="532">
  <data key="d9">ORDER</data>
  <data key="d10">false</data>
  <data key="d11">false</data>
  <data key="d12">523-532-0</data>
</edge>
...
<edge source="525" target="523">
  ...
  <data key="d12">525-523-0</data>
</edge>
<edge source="526" target="523">
  <data key="d9">KEYWORD</data>
  <data key="d13">"args.owner"</data>
  <data key="d12">526-523-0</data>
</edge>
<edge source="527" target="523">
  <data key="d9">KEYWORD</data>
  <data key="d13">"args.mode"</data>
  <data key="d12">527-523-0</data>
</edge>
<edge source="528" target="523">
  <data key="d9">KEYWORD</data>
  <data key="d13">"args.backup"</data>
  <data key="d12">528-523-0</data>
</edge>
</graph></graphml>