...
<node id="73">
  ...
  <data key="d12">"{{ sb_debian_base_admin_user_authorized_keys | join('\n') }}"</data>
  <data key="d13">[]</data>
</node>
<node id="74">
...
<node id="44">
  ...
  <data key="d12">"{{ 'admin' if (ansible_distribution == 'Debian') else 'ubuntu' }}"</data>
  <data key="d13">[]</data>
</node>
<node id="45">
  <data key="d2">IntermediateValue</data>
...
<node id="46">
  ...
  <data key="d12">"{{ sb_debian_base_admin_user }}"</data>
  <data key="d13">[]</data>
</node>
<node id="47">
  <data key="d2">IntermediateValue</data>
...
<edge source="74" target="225">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.key"</data>
  <data key="d18">74-225-0</data>
</edge>
...
<edge source="47" target="225">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.user"</data>
  <data key="d18">47-225-0</data>
</edge>
