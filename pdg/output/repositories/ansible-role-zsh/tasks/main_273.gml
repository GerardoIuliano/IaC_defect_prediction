...
<node id="266">
  ...
  <data key="d11">"timeout 10s /bin/zsh -c 'source {{ zsh_config }}; antigen reset'"</data>
  <data key="d12">[]</data>
</node>
<node id="267">
  <data key="d2">IntermediateValue</data>
...
<edge source="274" target="273">
  ...
  <data key="d16">274-273-0</data>
</edge>
<edge source="113" target="266">
  <data key="d15">USE</data>
  <data key="d16">113-266-0</data>
</edge>
