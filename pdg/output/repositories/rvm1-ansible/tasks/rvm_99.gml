...
<node id="103">
  ...
  <data key="d4">{"file": "unknown file", "line": -1, "column": -1, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/rvm1-ansible/tasks/main.yml", "line": 3, "column": 3, "includer_location": null}}</data>
  <data key="d12">"/usr/bin/env bash {{ rvm1_temp_download_path }}/rvm-installer.sh {{ rvm1_rvm_version }} --path {{ rvm1_install_path }} {{ rvm1_install_flags }}\n"</data>
  <data key="d13">[]</data>
</node>
<node id="104">
  <data key="d2">IntermediateValue</data>
...
<edge source="16" target="103">
  <data key="d15">USE</data>
  <data key="d16">16-103-0</data>
</edge>
<edge source="17" target="16">
  <data key="d15">DEF</data>
  <data key="d16">17-16-0</data>
</edge>
<edge source="33" target="103">
  <data key="d15">USE</data>
  <data key="d16">33-103-0</data>
</edge>
