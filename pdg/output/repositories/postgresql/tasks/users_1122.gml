...
<node id="1122">
  ...
  <data key="d6">"PostgreSQL | Ensure PostgreSQL is running"</data>
</node>
<node id="1123">
  <data key="d2">Literal</data>
  <data key="d3">1123</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/postgresql/tasks/users.yml", "line": 6, "column": 12, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/postgresql/tasks/main.yml", "line": 40, "column": 3, "includer_location": null}}</data>
...
<node id="1011">
  ...
  <data key="d6">"postgresql_service_name"</data>
  <data key="d9">0</data>
  <data key="d10">0</data>
  <data key="d11">0</data>
</node>
...
<node id="1115">
  ...
  <data key="d6">"postgresql_cold_started"</data>
  <data key="d9">0</data>
  <data key="d10">0</data>
...
<node id="1116">
  ...
  <data key="d5">"service"</data>
  <data key="d6">"PostgreSQL | Reload PostgreSQL configuration"</data>
</node>
<node id="1117">
  <data key="d2">Expression</data>
...
<edge source="1122" target="1126" id="1122-1126-0">
  <data key="d15">ORDER</data>
  <data key="d16">false</data>
  <data key="d17">false</data>
</edge>
<edge source="1123" target="1122" id="1123-1122-0">
