...
<node id="92">
  ...
  <data key="d12">"{{ ansible_env.SUDO_USER | default(ansible_env.USER) }}"</data>
  <data key="d13">[]</data>
</node>
<node id="93">
...
<node id="94">
  ...
  <data key="d12">"{{ controlhost_user }}"</data>
  <data key="d13">[]</data>
</node>
<node id="95">
  <data key="d2">IntermediateValue</data>
