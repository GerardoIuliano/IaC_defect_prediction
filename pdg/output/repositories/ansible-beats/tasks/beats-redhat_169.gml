...
<node id="171">
  ...
  <data key="d12">"yum versionlock add {{ beat }}{% if beats_version is defined and beats_version|length %}-{{ beats_version }}{% endif %}"</data>
  <data key="d13">[]</data>
</node>
<node id="172">
...
<edge source="172" target="169">
  ...
  <data key="d16">172-169-0</data>
</edge>
<edge source="173" target="169">
  <data key="d15">KEYWORD</data>
  <data key="d19">"become"</data>
  <data key="d16">173-169-0</data>
</edge>
...
<edge source="149" target="170">
  <data key="d15">USE</data>
  <data key="d16">149-170-0</data>
</edge>
<edge source="27" target="171">
  <data key="d15">USE</data>
  <data key="d16">27-171-0</data>
</edge>
</graph></graphml>