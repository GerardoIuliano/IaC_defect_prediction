...
<node id="558">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/ansible-redis/handlers/main.yml", "line": 2, "column": 3, "includer_location": null}</data>
  <data key="d14">"service"</data>
  <data key="d5">"restart redis"</data>
</node>
<node id="559">
  <data key="d2">Conditional</data>
  <data key="d3">559</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/ansible-redis/handlers/main.yml", "line": 6, "column": 9, "includer_location": null}</data>
</node>
<node id="560">
  <data key="d2">Literal</data>
  <data key="d3">560</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/ansible-redis/handlers/main.yml", "line": 5, "column": 12, "includer_location": null}</data>
...
<edge source="355" target="559">
  <data key="d15">USE</data>
  <data key="d16">355-559-0</data>
</edge>
...
<edge source="557" target="559">
  ...
  <data key="d16">557-559-0</data>
</edge>
<edge source="557" target="561">
  <data key="d15">ORDER</data>
  <data key="d17">false</data>
  <data key="d18">false</data>
  <data key="d16">557-561-0</data>
</edge>
<edge source="558" target="561">
  <data key="d15">ORDER</data>
  <data key="d17">false</data>
  <data key="d18">false</data>
  <data key="d16">558-561-0</data>
</edge>
...
<edge source="559" target="561">
  ...
  <data key="d17">false</data>
  <data key="d18">false</data>
  <data key="d16">559-561-0</data>
</edge>
<edge source="560" target="558">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.state"</data>
  <data key="d16">560-558-0</data>
</edge>
...
<edge source="383" target="558">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.name"</data>
  <data key="d16">383-558-0</data>
</edge>
</graph></graphml>