...
<node id="67">
  ...
  <data key="d7">"Create the pushgateway user"</data>
</node>
<node id="68">
...
<node id="71">
  <data key="d2">Literal</data>
  <data key="d3">71</data>
  <data key="d5">{"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/ansible-pushgateway/tasks/install.yml", "line": 19, "column": 12, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/ansible-pushgateway/tasks/main.yml", "line": 18, "column": 3, "includer_location": null}}</data>
  <data key="d10">"str"</data>
  <data key="d11">"/usr/sbin/nologin"</data>
</node>
<node id="72">
  <data key="d2">Literal</data>
  <data key="d3">72</data>
...
<node id="74">
  <data key="d2">Literal</data>
  <data key="d3">74</data>
  <data key="d5">{"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/ansible-pushgateway/tasks/install.yml", "line": 22, "column": 11, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/ansible-pushgateway/tasks/main.yml", "line": 18, "column": 3, "includer_location": null}}</data>
  <data key="d10">"str"</data>
  <data key="d11">"/"</data>
</node>
<node id="75">
  ...
  <data key="d6">"get_url"</data>
  <data key="d7">"Download pushgateway binary to local folder"</data>
</node>
<node id="14">
...
<node id="62">
  ...
  <data key="d7">"Create the pushgateway group"</data>
</node>
<node id="63">
  <data key="d2">Expression</data>
  <data key="d3">63</data>
...
<edge source="67" target="75">
  ...
  <data key="d17">67-75-0</data>
</edge>
<edge source="68" target="69">
  <data key="d15">DEF</data>
  <data key="d17">68-69-0</data>
</edge>
<edge source="69" target="67">
  <data key="d15">KEYWORD</data>
  <data key="d16">"args.name"</data>
  <data key="d17">69-67-0</data>
</edge>
<edge source="70" target="67">
  <data key="d15">KEYWORD</data>
  <data key="d16">"args.append"</data>
  <data key="d17">70-67-0</data>
</edge>
<edge source="71" target="67">
  <data key="d15">KEYWORD</data>
  <data key="d16">"args.shell"</data>
  <data key="d17">71-67-0</data>
</edge>
<edge source="72" target="67">
  <data key="d15">KEYWORD</data>
  <data key="d16">"args.system"</data>
  <data key="d17">72-67-0</data>
</edge>
<edge source="73" target="67">
  <data key="d15">KEYWORD</data>
  <data key="d16">"args.createhome"</data>
  <data key="d17">73-67-0</data>
</edge>
<edge source="74" target="67">
  <data key="d15">KEYWORD</data>
  <data key="d16">"args.home"</data>
  <data key="d17">74-67-0</data>
</edge>
