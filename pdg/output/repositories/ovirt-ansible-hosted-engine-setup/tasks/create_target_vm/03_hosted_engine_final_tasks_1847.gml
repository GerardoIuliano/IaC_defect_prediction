...
<node id="1848">
  ...
  <data key="d11">"he_vm_ip_addr is not none and he_vm_ip_addr | ipv6"</data>
  <data key="d12">["filter 'ipv6'"]</data>
</node>
<node id="953">
  <data key="d2">IntermediateValue</data>
...
<node id="1851">
  ...
  <data key="d9">"str"</data>
  <data key="d10">"templates/ifcfg-eth0-static-ipv6.j2"</data>
</node>
<node id="1852">
  <data key="d2">Literal</data>
...
<edge source="1835" target="1847">
  <data key="d15">KEYWORD</data>
  <data key="d17">"args.dest"</data>
  <data key="d16">1835-1847-0</data>
</edge>
