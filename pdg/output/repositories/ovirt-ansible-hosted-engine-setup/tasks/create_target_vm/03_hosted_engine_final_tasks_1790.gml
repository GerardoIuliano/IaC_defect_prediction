...
<node id="1786">
  ...
  <data key="d8">"Create configuration archive"</data>
</node>
<node id="1790">
  <data key="d2">Task</data>
  ...
  <data key="d8">"Create ovirt-hosted-engine-ha run directory"</data>
</node>
<node id="1791">
  <data key="d2">Literal</data>
  ...
  <data key="d5">"str"</data>
  <data key="d6">"/var/run/ovirt-hosted-engine-ha"</data>
</node>
<edge source="1792" target="1790">
  <data key="d9">KEYWORD</data>
  <data key="d10">"args.state"</data>
  <data key="d11">1792-1790-0</data>
</edge>
<edge source="1786" target="1790">
  <data key="d9">ORDER</data>
  <data key="d12">false</data>
  <data key="d13">false</data>
  <data key="d11">1786-1790-0</data>
</edge>
<edge source="1790" target="1794">
  <data key="d9">ORDER</data>
  <data key="d12">false</data>
  <data key="d13">false</data>
  <data key="d11">1790-1794-0</data>
</edge>
<edge source="1791" target="1790">
  <data key="d9">KEYWORD</data>
  <data key="d10">"args.path"</data>
  <data key="d11">1791-1790-0</data>
</edge>
</graph></graphml>