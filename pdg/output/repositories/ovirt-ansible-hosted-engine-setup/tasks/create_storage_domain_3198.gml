...
<node id="952">
  ...
  <data key="d7">"{{ hostvars[he_ansible_host_name]['he_local_vm_dir'] }}"</data>
  <data key="d8">[]</data>
</node>
<node id="953">
  <data key="d2">IntermediateValue</data>
...
<node id="3172">
  ...
  <data key="d7">"{{ disk_size_xml.matches[0].Disk['{http://schemas.dmtf.org/ovf/envelope/1/}size']|int * 1024 * 1024 * 1024 + storage_domain_details.ovirt_storage_domains[0].critical_space_action_blocker|int * 1024 * 1024 * 1024 + 5 * 1024 * 1024 * 1024 }}"</data>
  <data key="d8">[]</data>
</node>
<node id="3173">
  <data key="d2">IntermediateValue</data>
  <data key="d3">3173</data>
  <data key="d9">469</data>
</node>
<node id="3174">
  <data key="d2">Variable</data>
...
<node id="3191">
  ...
  <data key="d5">"ovirt_storage_domain"</data>
  <data key="d6">"Activate storage domain"</data>
</node>
<node id="3192">
  <data key="d2">Expression</data>
  ...
  <data key="d7">"storage_domain_details.ovirt_storage_domains[0].available|int &gt;= required_size|int"</data>
  <data key="d8">[]</data>
</node>
<node id="3193">
  <data key="d2">IntermediateValue</data>
  <data key="d3">3193</data>
  <data key="d9">472</data>
</node>
<node id="3194">
  <data key="d2">Conditional</data>
...
<node id="3199">
  ...
  <data key="d4">{"file": "unknown file", "line": -1, "column": -1, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/ovirt-ansible-hosted-engine-setup/tasks/partial_execution.yml", "line": 78, "column": 7, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/ovirt-ansible-hosted-engine-setup/tasks/main.yml", "line": 6, "column": 3, "includer_location": null}}}</data>
  <data key="d13">"str"</data>
  <data key="d14">"otopi_storage_domain_details"</data>
</node>
...
<edge source="3199" target="3198">
  <data key="d15">KEYWORD</data>
  <data key="d17">"args.var"</data>
  <data key="d16">3199-3198-0</data>
</edge>
</graph></graphml>