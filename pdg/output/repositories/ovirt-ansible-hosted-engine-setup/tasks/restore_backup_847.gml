...
<node id="848">
  ...
  <data key="d8">"engine-backup --mode=restore --log=/var/log/ovirt-engine/setup/restore-backup-$(date -u +%Y%m%d%H%M%S).log --file=/root/engine_backup --provision-all-databases --restore-permissions"</data>
</node>
<node id="849">
  ...
  <data key="d6">"engine_restore_out"</data>
  <data key="d9">0</data>
  <data key="d10">0</data>
