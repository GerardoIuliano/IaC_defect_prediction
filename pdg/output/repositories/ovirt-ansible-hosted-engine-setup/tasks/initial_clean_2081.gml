...
<node id="2081">
  ...
  <data key="d5">"Restore initial abrt config files"</data>
</node>
<node id="2082">
...
<node id="2078">
  ...
  <data key="d11">"[{'src': '/usr/share/abrt/conf.d/abrt-action-save-package-data.conf', 'dest': '/etc/abrt/abrt-action-save-package-data.conf'}, {'src': '/usr/share/abrt/conf.d/abrt.conf', 'dest': '/etc/abrt/abrt.conf'}, {'src': '/usr/share/abrt/conf.d/plugins/CCpp.conf', 'dest': '/etc/abrt/plugins/CCpp.conf'}, {'src': '/usr/share/abrt/conf.d/plugins/vmcore.conf', 'dest': '/etc/abrt/plugins/vmcore.conf'}]"</data>
</node>
<node id="2079">
...
<edge source="2084" target="2081">
  ...
  <data key="d16">2084-2081-0</data>
</edge>
<edge source="2085" target="2086">
  <data key="d15">DEF</data>
  <data key="d16">2085-2086-0</data>
</edge>
<edge source="2086" target="2081">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.dest"</data>
  <data key="d16">2086-2081-0</data>
</edge>
<edge source="2078" target="2079">
  <data key="d15">USE</data>
  <data key="d16">2078-2079-0</data>
</edge>
<edge source="2078" target="2080">
  <data key="d15">DEFLOOPITEM</data>
  <data key="d16">2078-2080-0</data>
</edge>
<edge source="2079" target="2081">
  <data key="d15">ORDER</data>
  <data key="d17">false</data>
  <data key="d18">false</data>
  <data key="d16">2079-2081-0</data>
</edge>
</graph></graphml>