...
<node id="3944">
  ...
  <data key="d12">"he_host_address in ['localhost', 'localhost.localdomain']"</data>
  <data key="d13">[]</data>
</node>
<node id="3945">
  <data key="d2">IntermediateValue</data>
  <data key="d3">3945</data>
  <data key="d14">579</data>
</node>
<node id="3946">
  <data key="d2">Conditional</data>
...
<node id="3947">
  ...
  <data key="d7">"str"</data>
  <data key="d8">"localhost is not a valid address\n"</data>
</node>
<node id="3953">
  <data key="d2">Conditional</data>
...
<edge source="3915" target="3944">
  <data key="d15">USE</data>
  <data key="d16">3915-3944-0</data>
</edge>
<edge source="3938" target="3946">
  <data key="d15">ORDER</data>
  <data key="d18">false</data>
  <data key="d19">false</data>
  <data key="d16">3938-3946-0</data>
</edge>
<edge source="3941" target="3938">
  <data key="d15">ORDER</data>
  <data key="d18">false</data>
  <data key="d19">false</data>
  <data key="d16">3941-3938-0</data>
</edge>
<edge source="3941" target="3946">
  <data key="d15">ORDER</data>
  <data key="d18">false</data>
  <data key="d19">false</data>
  <data key="d16">3941-3946-0</data>
</edge>
...
<edge source="3947" target="3943">
  <data key="d15">KEYWORD</data>
  <data key="d17">"args.msg"</data>
  <data key="d16">3947-3943-0</data>
</edge>
