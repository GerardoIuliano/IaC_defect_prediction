...
<node id="748">
  ...
  <data key="d12">"{{ hostvars[he_ansible_host_name]['local_vm_ip']['stdout_lines'][0] }} {{ he_fqdn }} # hosted-engine-setup-{{ hostvars[he_ansible_host_name]['he_local_vm_dir'] }}"</data>
  <data key="d13">[]</data>
</node>
<node id="749">
...
<edge source="743" target="746">
  ...
  <data key="d16">743-746-0</data>
</edge>
<edge source="743" target="915">
  <data key="d15">ORDER</data>
  <data key="d17">false</data>
  <data key="d18">false</data>
  <data key="d16">743-915-0</data>
</edge>
