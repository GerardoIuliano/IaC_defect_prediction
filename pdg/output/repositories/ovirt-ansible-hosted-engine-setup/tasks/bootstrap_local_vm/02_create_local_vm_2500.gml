...
<node id="2501">
  ...
  <data key="d7">"gzip -l \"{{ he_appliance_ova_path }}\" | grep -v uncompressed | awk '{print $2}'"</data>
  <data key="d8">[]</data>
</node>
<node id="2502">
  <data key="d2">IntermediateValue</data>
  <data key="d3">2502</data>
  <data key="d9">388</data>
</node>
<node id="2503">
...
<node id="622">
  ...
  <data key="d7">"he_appliance_ova is not none and he_appliance_ova|length &gt; 0"</data>
  <data key="d8">[]</data>
</node>
<node id="2575">
  <data key="d2">Task</data>
...
<node id="625">
  ...
  <data key="d7">"{{ he_appliance_ova }}"</data>
  <data key="d8">[]</data>
</node>
<node id="626">
  <data key="d2">IntermediateValue</data>
...
<edge source="2502" target="2500">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args._raw_params"</data>
  <data key="d18">2502-2500-0</data>
</edge>
...
<edge source="626" target="2495">
  <data key="d15">DEF</data>
  <data key="d18">626-2495-0</data>
</edge>
<edge source="2494" target="2495">
  <data key="d15">DEFINEDIF</data>
  <data key="d18">2494-2495-0</data>
</edge>
<edge source="2495" target="2501">
  <data key="d15">USE</data>
  <data key="d18">2495-2501-0</data>
</edge>
</graph></graphml>