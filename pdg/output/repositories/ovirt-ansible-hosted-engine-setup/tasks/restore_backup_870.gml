...
<node id="871">
  ...
  <data key="d7">"psql -d engine -c \"UPDATE vm_dynamic SET migrating_to_vds = NULL, status=0 /* Down */ WHERE migrating_to_vds IN (SELECT vds_id FROM vds WHERE upper(vds_unique_id)=upper('{{ hostvars[he_ansible_host_name]['unique_id_out']['stdout_lines']|first }}'))\""</data>
  <data key="d8">[]</data>
</node>
<node id="872">
...
<node id="873">
  ...
  <data key="d6">"db_update_host_migrating_vms"</data>
  <data key="d10">0</data>
  <data key="d11">0</data>
...
<edge source="872" target="870">
  ...
  <data key="d18">872-870-0</data>
</edge>
<edge source="874" target="870">
  <data key="d15">KEYWORD</data>
  <data key="d19">"become"</data>
  <data key="d18">874-870-0</data>
</edge>
<edge source="875" target="870">
  <data key="d15">KEYWORD</data>
  <data key="d19">"become_user"</data>
  <data key="d18">875-870-0</data>
</edge>
<edge source="876" target="870">
  <data key="d15">KEYWORD</data>
  <data key="d19">"become_method"</data>
  <data key="d18">876-870-0</data>
</edge>
