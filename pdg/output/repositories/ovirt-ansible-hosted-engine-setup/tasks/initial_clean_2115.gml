...
<node id="2116">
  ...
  <data key="d9">"local_vm_list_all"</data>
  <data key="d10">1</data>
  <data key="d11">0</data>
...
<node id="213">
  ...
  <data key="d5">"virsh list --all | grep {{ he_vm_name }}Local | cat"</data>
  <data key="d6">[]</data>
</node>
<node id="214">
  <data key="d2">IntermediateValue</data>
...
<edge source="2" target="213">
  <data key="d15">USE</data>
  <data key="d16">2-213-0</data>
</edge>
...
<edge source="214" target="2115">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args._raw_params"</data>
  <data key="d16">214-2115-0</data>
</edge>
