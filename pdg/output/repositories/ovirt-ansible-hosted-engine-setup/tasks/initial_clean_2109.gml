...
<node id="203">
  ...
  <data key="d11">"virsh list | grep {{ he_vm_name }}Local | cat"</data>
  <data key="d12">[]</data>
</node>
<node id="204">
...
<node id="2105">
  ...
  <data key="d7">"Start libvirt"</data>
</node>
<node id="2109">
  <data key="d2">Task</data>
  ...
  <data key="d7">"Check for leftover local Hosted Engine VM"</data>
</node>
<node id="2110">
  <data key="d2">Variable</data>
  ...
  <data key="d7">"local_vm_list"</data>
  <data key="d8">1</data>
  <data key="d9">0</data>
