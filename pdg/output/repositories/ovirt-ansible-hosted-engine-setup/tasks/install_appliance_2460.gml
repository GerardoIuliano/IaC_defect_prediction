...
<node id="585">
  ...
  <data key="d7">"he_appliance_ova is none or he_appliance_ova|length == 0"</data>
  <data key="d8">[]</data>
</node>
<node id="586">
...
<node id="2461">
  ...
  <data key="d13">"str"</data>
  <data key="d14">"ovirt-engine-appliance"</data>
</node>
<node id="2462">
  <data key="d2">Literal</data>
