...
<node id="1427">
  ...
  <data key="d11">"Error: the target storage domain contains only {{ storage_domain_details.ovirt_storage_domains[0].available|int / 1024 / 1024 / 1024 }}GiB of available space while a minimum of {{ required_size|int / 1024 / 1024 / 1024 }}GiB is required If you wish to use the current target storage domain by extending it, make sure it contains nothing before adding it."</data>
  <data key="d12">[]</data>
</node>
<node id="1428">
  <data key="d2">IntermediateValue</data>
...
<edge source="1412" target="1427">
  <data key="d15">USE</data>
  <data key="d17">1412-1427-0</data>
</edge>
...
<edge source="1427" target="1428">
  <data key="d15">DEF</data>
  <data key="d17">1427-1428-0</data>
</edge>
<edge source="1428" target="1425">
  <data key="d15">KEYWORD</data>
  <data key="d16">"args.msg"</data>
  <data key="d17">1428-1425-0</data>
</edge>
...
<edge source="1391" target="1427">
  <data key="d15">USE</data>
  <data key="d17">1391-1427-0</data>
</edge>
