...
<node id="1159">
  ...
  <data key="d5">"datadog_agent_major_version | int &gt; 5 and ansible_facts.os_family != \"Windows\" and ansible_facts.os_family != \"Darwin\""</data>
  <data key="d6">[]</data>
</node>
<node id="1160">
  <data key="d2">IntermediateValue</data>
  <data key="d3">1160</data>
  <data key="d7">215</data>
</node>
<node id="1161">
...
<node id="1162">
  ...
  <data key="d8">"service_facts"</data>
  <data key="d9">"Populate service facts"</data>
</node>
<node id="1175">
  <data key="d2">Conditional</data>
...
<node id="288">
  ...
  <data key="d9">"datadog_agent_major_version"</data>
  <data key="d12">3</data>
  <data key="d13">0</data>
...
<node id="44">
  ...
  <data key="d9">"datadog_agent_version"</data>
  <data key="d12">0</data>
  <data key="d13">0</data>
  <data key="d14">1</data>
</node>
...
<node id="176">
  ...
  <data key="d9">"Check that datadog_checks is a mapping"</data>
</node>
<node id="183">
  <data key="d2">Expression</data>
...
<node id="190">
  ...
  <data key="d9">"agent_version"</data>
  <data key="d12">0</data>
  <data key="d13">0</data>
  <data key="d14">18</data>
</node>
...
<node id="204">
  ...
  <data key="d9">"datadog_major"</data>
  <data key="d12">0</data>
  <data key="d13">0</data>
  <data key="d14">18</data>
</node>
