...
<node id="878">
  ...
  <data key="d10">"win_reg_stat"</data>
...
<node id="879">
  ...
  <data key="d12">"HKLM:\\SOFTWARE\\Datadog\\Datadog Agent"</data>
</node>
<node id="880">
  <data key="d2">Literal</data>
...
<node id="882">
  ...
  <data key="d10">"win_reg_stat"</data>
  <data key="d6">"Check existing installPath Directory"</data>
</node>
<node id="114">
  <data key="d2">Variable</data>
...
<node id="886">
  ...
  <data key="d6">"Validate config path"</data>
</node>
<node id="887">
  ...
  <data key="d13">"( (config_root_from_registry.exists) and (datadog_windows_config_files_dir | length &gt; 0 ) and (config_root_from_registry.value | regex_replace('\\\\\\\\$','') | lower != datadog_windows_config_files_dir | lower ) )"</data>
  <data key="d14">[]</data>
</node>
<node id="888">
  <data key="d2">IntermediateValue</data>
...
<node id="890">
  ...
  <data key="d5">{"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/ansible-datadog/tasks/pkg-windows-opts.yml", "line": 31, "column": 10, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/ansible-datadog/tasks/pkg-windows.yml", "line": 34, "column": 3, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/ansible-datadog/tasks/main.yml", "line": 45, "column": 3, "includer_location": null}}}</data>
  <data key="d13">"Incompatible configuration option {{ config_root_from_registry.value }} != {{ datadog_windows_config_files_dir }}"</data>
  <data key="d14">[]</data>
</node>
<node id="891">
  <data key="d2">IntermediateValue</data>
...
<edge source="881" target="887">
  <data key="d15">USE</data>
  <data key="d16">881-887-0</data>
</edge>
<edge source="881" target="890">
  <data key="d15">USE</data>
  <data key="d16">881-890-0</data>
</edge>
<edge source="882" target="889">
  <data key="d15">ORDER</data>
  <data key="d17">false</data>
  <data key="d18">false</data>
  <data key="d16">882-889-0</data>
</edge>
<edge source="114" target="887">
  <data key="d15">USE</data>
  <data key="d16">114-887-0</data>
</edge>
<edge source="114" target="890">
  <data key="d15">USE</data>
  <data key="d16">114-890-0</data>
</edge>
...
<edge source="891" target="886">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.msg"</data>
  <data key="d16">891-886-0</data>
</edge>
