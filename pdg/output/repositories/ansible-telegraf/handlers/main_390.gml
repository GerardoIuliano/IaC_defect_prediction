...
<node id="391">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/ansible-telegraf/handlers/main.yml", "line": 10, "column": 11, "includer_location": null}</data>
  <data key="d7">"str"</data>
  <data key="d8">"ntp"</data>
</node>
<node id="392">
  <data key="d2">Literal</data>
  <data key="d3">392</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/ansible-telegraf/handlers/main.yml", "line": 11, "column": 12, "includer_location": null}</data>
  <data key="d7">"str"</data>
...
<edge source="391" target="390">
  ...
  <data key="d12">391-390-0</data>
</edge>
<edge source="392" target="390">
  <data key="d9">KEYWORD</data>
  <data key="d13">"args.state"</data>
  <data key="d12">392-390-0</data>
</edge>
</graph></graphml>