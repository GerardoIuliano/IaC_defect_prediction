...
<node id="100">
  ...
  <data key="d7">"nrinfragent_os_name == 'redhat' and ansible_version.full is version(\"2.8.0\", '&gt;=')"</data>
  <data key="d8">[]</data>
</node>
<node id="101">
...
<node id="103">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/infrastructure-agent-ansible/tasks/install_dist_pkgs.yml", "line": 10, "column": 11, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/infrastructure-agent-ansible/tasks/main.yml", "line": 10, "column": 3, "includer_location": null}}</data>
  <data key="d10">"str"</data>
  <data key="d11">"redhat-lsb-core"</data>
</node>
<node id="104">
  <data key="d2">Literal</data>
  <data key="d3">104</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/infrastructure-agent-ansible/tasks/install_dist_pkgs.yml", "line": 11, "column": 12, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/infrastructure-agent-ansible/tasks/main.yml", "line": 10, "column": 3, "includer_location": null}}</data>
  <data key="d10">"str"</data>
...
<node id="105">
  ...
  <data key="d7">"{{ nrinfragent_yum_lock_timeout }}"</data>
  <data key="d8">[]</data>
</node>
<node id="106">
  <data key="d2">IntermediateValue</data>
...
<node id="10">
  ...
  <data key="d6">"nrinfragent_yum_lock_timeout"</data>
  <data key="d12">0</data>
  <data key="d13">0</data>
  <data key="d14">1</data>
</node>
...
<node id="89">
  ...
  <data key="d5">"yum"</data>
  <data key="d6">"confirm redhat lsb util is present pre2.8.0"</data>
</node>
<node id="90">
  <data key="d2">Variable</data>
  <data key="d3">90</data>
...
<edge source="106" target="99">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.lock_timeout"</data>
  <data key="d18">106-99-0</data>
</edge>
<edge source="10" target="105">
  <data key="d15">USE</data>
  <data key="d18">10-105-0</data>
</edge>
